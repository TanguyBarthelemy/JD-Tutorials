...
-   [v3.0.2](https://github.com/jdemetra/jdplus-main/releases/tag/v3.0.2) : la nouvelle version de JDemetra+ avec de nouvelles fonctionnalités et une nouvelle interface
...
-   **Télécharger** le fichier binaire `R-4.3.1-win.exe` sous `r colFmt("https://cran.rstudio.com/bin/windows/base/", html_color)`
...
Exemple pour le package **rjd3toolkit**, le `Source code (tar.gz)` se trouve sous `r colFmt("https://github.com/rjdemetra/rjd3toolkit/releases/tag/v3.0.0", html_color)` (*release* Section). Après l'avoir récupéré, il faut lancer la commande d'installation :
