...
For the package **rjd3toolkit**, you need to search under `r colFmt("https://github.com/rjdemetra/rjd3toolkit/releases/tag/v3.0.0", color = html_color, url = TRUE)` (*release* Section) then launch the installation code:
