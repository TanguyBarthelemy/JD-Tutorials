...
-   [v3.2.1](https://github.com/jdemetra/jdplus-main/releases/tag/v3.2.1): the new JDemetra+ version with new features and a new GUI
...
ℹ Advice: If you want to use several versions of JDemetra+ (v2.2.4, v3.2.1, ...), you can rename the unzipped folder in `r color_format("\\nbdemetra-2.2.4\\", color = windows_path_color, url = FALSE)` and `r color_format("\\nbdemetra-3.2.1\\", color = windows_path_color, url = FALSE)`.
...
The version 3.2.1 of JDemetra+ contains a
JDemetra+ version 3.2.1 contains a jdk 17 (java 17 version) packaged in [.zip](https://github.com/jdemetra/jdplus-main/releases/tag/v3.2.1). So to use the interface, it is not necessary to install Java 17.
...
For the package [**{rjd3toolkit}**]{.RPackages}, you need to search under `r color_format("https://github.com/rjdemetra/rjd3toolkit/releases/tag/v3.1.0", color = html_color, url = TRUE)` (*release* Section) then launch the installation code:
